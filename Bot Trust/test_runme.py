...
class TestRunme(unittest.TestCase):
    ...
    def test_time_to_move_and_push(self):
        self.assertEqual(runme.time_to_move_and_push(1, 10), 10)
        self.assertEqual(runme.time_to_move_and_push(10, 1), 10)

    def test_time_to_push(self):
        sequence = ["B 1", "B 4", "B 1"]
        self.assertEqual(runme.time_to_push(sequence), 9)
        sequence = ["O 1", "B 4", "O 2"]
        self.assertEqual(runme.time_to_push(sequence), 5)
